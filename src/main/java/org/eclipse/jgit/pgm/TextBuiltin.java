 ...
 * {@link #execute()} method is invoked with the arguments that appear
...
public abstract class TextBuiltin {
	 ...
	 * <p>
	 * This method should only be invoked by {@link #execute()}, prior
...
//		}
	 ...
	 * <p>
	 * This method should only be invoked by {@link #execute()}.
	 *
	 * @throws Exception
	 *             an error occurred while processing the command. The main
	 *             framework will catch the exception and print a message on
